...
public class QueryDepartment implements CustomerCare {
	...
	public void getProblem() {
		this.refId = Math.round(Math.random()*(1000-1+1)+1);
		System.out.println("Dear "+this.customerName+" your  issue '"+this.issue+"' is registered with Payments and reference id:"+this.refId);
	} 
